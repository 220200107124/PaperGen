    ...
    return (
        <div className="flex h-screen bg-bg-gray overflow-hidden">
            ...
            <div className="flex-1 flex flex-col min-w-0 h-full relative">
                <TopNavbar />
                <main className="flex-1 p-4 md:p-8 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-200 flex flex-col">
                    <div className="max-w-[1400px] mx-auto pb-10 md:pb-8 flex-1 w-full">
                        <Outlet />
                    </div>
                    {/* Dashboard Footer */}
                    <footer className="max-w-[1400px] w-full mx-auto mt-auto pt-6 border-t border-gray-200/60 pb-4">
                        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                            <p className="text-xs font-black text-gray-400 uppercase tracking-[0.2em] text-center md:text-left">
